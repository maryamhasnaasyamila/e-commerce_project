            ...
            <div class="card-body">
                <form method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="nama" name="nama" placeholder="Example: One Piece Spring Dress" value="<?php if (isset($_GET['idedit'])) {echo $data['nama'];} ?>" type="text" required="required" class="form-control">
                        <?php 
                         if (isset($_GET['idedit'])) {
                        ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <textarea id="deskripsi" name="deskripsi" cols="40" rows="4" placeholder="Example:
The one piece summer dress is a stylish and comfortable garment designed for warm weather. It features a single piece design that covers the torso and extends down to the legs, providing a cool and breezy outfit option for any summertime occasion." 
                        value="<?php if (isset($_GET['idedit'])) {echo $data['deskripsi'];} ?>" type="text" required="required" class="form-control"></textarea>
                        </div>
                    </div> 

                    <div class="form-group row">
                        <label for="tipe_pakaian_id" class="col-4 col-form-label">Category</label> 
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="harga" name="harga" type="number" placeholder="Minimun Rp. 50.000" min="50000" value="<?php if (isset($_GET['idedit'])) {echo $data['harga'];} ?>" required="required" class="form-control">
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="foto" name="foto" placeholder="https://pin.it/7lJRLzY" value="<?php if (isset($_GET['idedit'])) {echo $data['foto'];} ?>" type="text" required="required" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input id="ukuranXXL" name="ukuran" type="radio" class="custom-control-input" required="required" value="XXL" <?php if(isset($_GET['idedit'])) {if ($data['ukuran'] == "XXL") {echo "checked";}} ?>>
                            <label for="ukuranXXL" class="custom-control-label"> XXL</label>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="stok" class="col-4 col-form-label">Available Stock</label> 
                        <div class="col-8">
                        <input id="stok" name="stok" type="number" placeholder="Example: 65" min="1" value="<?php if (isset($_GET['idedit'])) {echo $data['stok'];} ?>" required="required" class="form-control">
                        </div>
                    </div>  
